...
export default function ScheduleSheet({
  ...
  return (
    <div className="absolute inset-0 z-20 flex flex-col justify-end">
      ...
      <div
        ref={sheetRef}
        className="relative flex h-[82%] flex-col rounded-t-3xl bg-white pb-5 shadow-2xl"
        style={{
            ...
            {items.map((s) => (
              <li key={s.id} className="flex gap-3">
                ...
                <div className="mb-3 flex-1">
                  <div className="flex items-start justify-between rounded-2xl border border-green-400 bg-green-50 p-3">
